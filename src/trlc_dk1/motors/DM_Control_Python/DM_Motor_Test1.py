...
Motor1=Motor(DM_Motor_Type.DM4310,0x04,0x14)
Motor2=Motor(DM_Motor_Type.DM4310,0x05,0x15)
Motor3=Motor(DM_Motor_Type.DM4310,0x06,0x16)
...
print("Motor3:")
print("PMAX:",MotorControl1.read_motor_param(Motor3,DM_variable.PMAX))
print("MST_ID:",MotorControl1.read_motor_param(Motor3,DM_variable.MST_ID))
print("VMAX:",MotorControl1.read_motor_param(Motor3,DM_variable.VMAX))
print("TMAX:",MotorControl1.read_motor_param(Motor3,DM_variable.TMAX))
